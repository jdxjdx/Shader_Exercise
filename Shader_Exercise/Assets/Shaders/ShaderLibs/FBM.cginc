...
{
	float f = 0.0;
	f += 0.50000*SNoise( p*1.0  ); 
	f += 0.25000*SNoise( p*2.03  ); 
	f += 0.12500*SNoise( p*4.01  ); 
	f += 0.06250*SNoise( p*8.05  ); 
	f += 0.03125*SNoise( p*16.02 );
	return f/0.984375;
}
...
{
	float f = 0.0;
	f += 0.50000*VNoise( p*1.0  ); 
	f += 0.25000*VNoise( p*2.03  ); 
	f += 0.12500*VNoise( p*4.01  ); 
	f += 0.06250*VNoise( p*8.05  ); 
	f += 0.03125*VNoise( p*16.02 );
	return f/0.984375;
}
